...
describe("utils", () => {
    ...
    describe("getRemoteEndpointSettings", () => {
        ...
        it("uses correct fallbacks on failure", async () => {
            ...
            expect(userDataDir).toEqual(expect.stringContaining(`network-edge-devtools-userdatadir_${port}`));
        });
        ...
        it("uses correct user data directory", async () => {
            ...
            expect(result.userDataDir).toEqual(expect.stringContaining("network-edge-devtools-userdatadir_"));
            ...
            expect(result5.userDataDir).toEqual(expect.stringContaining("network-edge-devtools-userdatadir_"));
